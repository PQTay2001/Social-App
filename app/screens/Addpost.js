  ...
  return (
    ...
    <View style={{padding:RFPercentage(2)}}>
        ...
        <Ionicons name="chevron-back" size={30} color={colors.mblack} />
            ...
            <Text style={{fontSize:RFPercentage(2.5)}}>Đăng bài viết</Text>
            <TouchableOpacity>
      ...
      <Ionicons name="camera" size={30} color="white"  />
            ...
            <TextInput style={{borderColor:colors.grey,borderWidth:1,color:colors.mblack,height:RFPercentage(7),width:"100%",borderRadius:RFPercentage(1),padding:RFPercentage(2),marginVertical:RFPercentage(2)}} placeholder='Nội dung' onChangeText={(text)=>setcapt(text)} value={capt} />
<TextInput style={{borderColor:colors.grey,borderWidth:1,color:colors.mblack,height:RFPercentage(7),width:"100%",borderRadius:RFPercentage(1),padding:RFPercentage(2)}} placeholder='Địa điểm' onChangeText={(text)=>setloca(text)} value={loca} />
<TouchableOpacity onPress={addpost} style={{backgroundColor:colors.pink,height:RFPercentage(7),width:"100%",borderRadius:RFPercentage(1),padding:RFPercentage(2),marginVertical:RFPercentage(2)}}>
    <Text style={{color:colors.white,textAlign:"center",fontWeight:"bold"}}>Đăng tải</Text>
</TouchableOpacity>
        </View>
        </View>    
</ScrollView>
